...
#pragma warning disable CS1591 // Missing XML comment for publicly visible type or member
    ...
    public static class DiagnosticsLoggerExtensions
    {
        ...
        public static void CommandExecuted(this ILogger logger, ShellContext context, Endpoint endpoint)
        {
            logger.Log(
                LogLevel.Trace,
                _commandRequest,
        ...
        public static void CommandResponse(this ILogger logger, ShellContext context)
        {
            logger.Log(
                LogLevel.Trace,
                _commandResponse,
        ...
        public static void LoginSucceeded(this ILogger logger, ShellContext context)
        {
        ...
        public static void LoginFailed(this ILogger logger, ShellContext context, string message)
        {
            logger.Log(
                LogLevel.Information,
                _loginFailed,
