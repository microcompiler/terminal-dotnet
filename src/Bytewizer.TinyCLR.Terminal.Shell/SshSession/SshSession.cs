...
namespace Bytewizer.TinyCLR.SecureShell
{
    public class SshSession : IDynamicInvoker
    {
        ...
        private Queue _blockedMessages = new Queue();
                ...
                ShellServerOptions terminalOptions)
        {
            ...
            ServerVersion = terminalOptions.ProtocolExchangeMessage;
        }
        ...
        public void EstablishConnection()
        {
            ...
            if (!ClientVersion.ToUpper().StartsWith("SSH-2.0"))
            {
        ...
        //private bool ValidateHandshakeVersion(ShellContext context, out string clientVersion)
        //{
        ...
        //            do
        //            {
        //                clientVersion = reader.ReadLine() ?? string.Empty;
        //            } while (!clientVersion.ToUpper().StartsWith("SSH-2.0"));

        //            var dummy = new char[255];
        //            reader.Read(dummy, 0, dummy.Length);
        ...
        private string SocketReadProtocolVersion()
        {
            ...
            {
                len = _context.Channel.Read(buffer);
        ...
        {
            _context.Channel.WriteLine(ServerVersion);
        ...
        private Message ReceiveMessage()
        {
            ...
            var followingBlocks = new byte[bytesToRead];
            _context.Channel.Read(followingBlocks);
        ...
        private void SendMessageInternal(Message message)
        {
            ...
            _context.Channel.Write(payload);
            //SocketWrite(payload);
        ...
        private void ContinueSendBlockedMessages()
        {
            if (_blockedMessages.Count > 0)
            {
                //try
                //{
                //    var message = (Message)_blockedMessages.Dequeue();
                //    SendMessageInternal(message);
                //}
                //catch { };
